...
let codeLocale = `
import { resetConfirmButtonLocales } from "@worktools/meson-modal";
  ...
  return (
    <div className={styleContainer}>
      <div className={styleBoxArea}>
        <div>
          <DocDemo title="Confirm" link="https://github.com/worktools/meson-modal/blob/master/example/pages/demos/confirm.tsx">
            <JimoButton
              onClick={async () => {
                setResult(null);
                let result = await confirmPlugin.forConfirmation({
